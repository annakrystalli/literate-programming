...
<div class="alert alert-info"><strong>https://annakrystalli.me/literate-programming/</strong></div>

### **Handout at: [annakrystalli.me/literate-programming/](annakrystalli.me/literate-programming/)**
...
**Simple interface to powerfull modern web technologies and libraries**
...
```{r echo=F}
magick::image_read("assets/knit.png")
```
...
[<img src="assets/cheat.png" width="500px"/>](https://www.rstudio.com/wp-content/uploads/2015/02/rmarkdown-cheatsheet.pdf)
